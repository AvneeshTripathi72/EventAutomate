// Hardcoded fallback environment configuration for production bypass and deployment resilience
export const ENV = {
  ...
  SUPER_ADMIN_EMAIL: process.env.SUPER_ADMIN_EMAIL || "scrimsgame8@gmail.com",
  SUPER_ADMIN_PASSWORD: process.env.SUPER_ADMIN_PASSWORD || "Scrimsgame@123456789",
...
// Polyfill missing keys into process.env so third-party libs or direct process.env reads also get fallbacks
