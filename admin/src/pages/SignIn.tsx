        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col gap-1 mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/admin/signup">
                <a className="font-bold hover:underline" style={{ color: SKY }}>Register your company here</a>
              </Link>
            </p>
          </div>
          ...
          {tab === "signin" ? (
            ...
            <div className="text-center py-8" data-testid="trial-success">
              ...
              <h3 className="text-lg font-black mb-1" style={{ color: NAVY }}>Registration successful</h3>
              <p className="text-sm text-muted-foreground mb-5">Please check your email to verify your account. Once verified, you can sign in to your workspace.</p>
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Input id="t-password" type={showSignUpPassword ? "text" : "password"} value={trial.password} onChange={(e) => setTrial({ ...trial, password: e.target.value })} placeholder="••••••••" data-testid="input-trial-password" required className="pr-10" />
                        <button type="button" onClick={() => setShowSignUpPassword((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground" aria-label={showSignUpPassword ? "Hide password" : "Show password"}>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Input id="t-confirmpassword" type={showSignUpConfirmPassword ? "text" : "password"} value={trial.confirmPassword} onChange={(e) => setTrial({ ...trial, confirmPassword: e.target.value })} placeholder="••••••••" data-testid="input-trial-confirmpassword" required className="pr-10" />
                        <button type="button" onClick={() => setShowSignUpConfirmPassword((v) => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground" aria-label={showSignUpConfirmPassword ? "Hide password" : "Show password"}>
