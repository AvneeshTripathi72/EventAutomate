...
import aboutMenuImage from "@assets/generated_images/hero_collaboration.webp";
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* ── Top ribbon ── */}
      <div className="hidden md:block bg-[#0d2137] border-b border-white/10 relative z-40">
      ...
      {/* ── Sticky Container (Logo + Main Header) ── */}
      <div className="sticky top-0 z-50 w-full shadow-sm">
        
        {/* Logo card (Hangs down from top of white header) */}
        ...
        {/* ── Main header bar ── */}
        <div className="bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b relative z-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center gap-4">
            ...
            <nav className="hidden md:flex items-center gap-1">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 text-sm font-bold uppercase tracking-wider px-3 py-2 rounded-md text-foreground/70 hover:text-primary transition-colors"
                >
                  Home
                </Link>
